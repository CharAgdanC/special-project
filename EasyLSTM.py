...
#載入訓練資料
DataName = os.getcwd()+'C:\\Users\\user\\Desktop\\AI CUP 2024\\示範程式\\微氣候數據處理(比賽用)\\微氣候數據處理(比賽用)\\source\\AvgDATA_17_2024x10x22T20x42x32Z.csv'
