...
#載入訓練資料
DataName = os.getcwd()+'\ExampleTrainData(AVG)\AvgDATA_01.csv'
...
#============================預測數據============================
#載入模型
regressor = load_model('C:\\Users\\user\\Desktop\\AI CUP 2024\\示範程式\\LSTM+迴歸分析(比賽用)\\LSTM+迴歸分析(比賽用)\\WheatherLSTM_2024-11-16T03_46_11Z.h5')
Regression = joblib.load('C:\\Users\\user\\Desktop\\AI CUP 2024\\示範程式\\LSTM+迴歸分析(比賽用)\\LSTM+迴歸分析(比賽用)\\WheatherRegression_2024-11-16T03_46_14Z')
